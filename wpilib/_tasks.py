...
@task(
    pre=[
        wpiutil_tasks.develop,
        wpimath_tasks.develop,
        hal_tasks.develop,
        ntcore_tasks.develop,
    ]
)
...
@task(
    pre=[
        wpiutil_tasks.build_wheel,
        wpimath_tasks.build_wheel,
        hal_tasks.build_wheel,
        ntcore_tasks.build_wheel,
    ]
)
